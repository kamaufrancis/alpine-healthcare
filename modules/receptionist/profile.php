<?php
// modules/reception/profile.php - Reception Profile
require_once '../../core/auth.php';
requireLogin();
require_once '../../config/database.php';

// Ensure only reception staff can access
        ...
        <div class="row g-0">
            ...
            <main class="col-md-10 main-content">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-4 col-md-3">
                        <div class="stat-box">
                            <span class="icon"><i class="bi bi-clock-history text-warning"></i></span>
                            <?php
                    ...
                    <div class="col-4 col-md-3">
                        <div class="stat-box">
                            <span class="icon"><i class="bi bi-receipt text-info"></i></span>
                            <?php
                            $stmt = $pdo->query("SELECT COUNT(*) as total FROM invoices WHERE DATE(created_at) = CURDATE()");
                            $today_invoices = $stmt->fetch(PDO::FETCH_ASSOC)['total'];
                            ?>
                            <div class="number"><?php echo $today_invoices; ?></div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="text-center mb-4">
                                    ...
                                    <span class="badge bg-success"><?php echo ucfirst($user_data['role'] ?? 'receptionist'); ?></span>
                                </div>
                                ...
                                <form method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" 
                                               value="<?php echo ucfirst($user_data['role'] ?? 'receptionist'); ?>" disabled>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 text-center">
                                        <div class="p-3 bg-light rounded">
                                            <h5><?php echo ucfirst($user_data['role'] ?? 'receptionist'); ?></h5>
