<?php
// modules/reception/billing_create.php - Create Invoice
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $service_name = trim($_POST['service_name'] ?? 'Consultation');
    $amount = floatval($_POST['amount']);
    $payment_status = $_POST['payment_status'] ?? 'pending';
    $invoice_number = 'INV-' . date('Y') . '-' . str_pad(rand(1, 9999), 4, '0', STR_PAD_LEFT);
    
    if (empty($patient_id) || $amount <= 0) {
        $error = 'Please select a patient and enter a valid amount.';
    } else {
        $stmt = $pdo->prepare("
            INSERT INTO invoices (patient_id, invoice_number, service_name, amount, payment_status) 
            VALUES (?, ?, ?, ?, ?)
        ");
        $stmt->execute([$patient_id, $invoice_number, $service_name, $amount, $payment_status]);
        ...
        <div class="row g-0">
            ...
            <main class="col-md-10 main-content">
                <div class="page-header">
                    <div>
                        <h1><i class="bi bi-receipt-plus"></i> <?php echo $page_title; ?></h1>
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="bi bi-receipt-plus"></i> Invoice Details
                    </div>
                    <div class="card-body">
                        <form method="POST">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="amount" class="form-control" 
                                           value="500" step="10" min="0" required>
                                </div>
                                <div class="col-md-6 mb-3">
