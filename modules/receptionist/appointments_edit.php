<?php
// modules/reception/appointments_edit.php - Edit Appointment
...
$doctors = $pdo->query("SELECT id, fullname FROM users WHERE role = 'doctor' ORDER BY fullname")->fetchAll();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($patient_id) || empty($doctor_id) || empty($appointment_date)) {
        ...
        $stmt = $pdo->prepare("
            ...
            WHERE id = ?
        ");
        $stmt->execute([$patient_id, $doctor_id, $appointment_date, $reason, $status, $id]);
            ...
            <main class="col-md-10 main-content">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="bi bi-pencil-square"></i> Edit Appointment #<?php echo $appointment['id']; ?>
                    </div>
                    <div class="card-body">
                        <form method="POST">
                            <div class="row">
