<?php
// modules/admin/profile.php - Admin Profile with Profile Picture
    ...
    <style>
        * { font-family: 'Inter', -apple-system, BlinkMacSystemFont, sans-serif; }
        ...
        .sidebar .avatar {
            ...
            font-size: 18px;
            flex-shrink: 0;
            overflow: hidden; /* NEW: Ensures image stays inside circle */
        }
        .sidebar .avatar img {
            width: 100%;
            height: 100%;
        ...
        .sidebar .avatar.admin { background: linear-gradient(135deg, #e74c3c, #c0392b); }
        ...
        .form-control:focus { border-color: #e74c3c; box-shadow: 0 0 0 0.2rem rgba(231, 76, 60, 0.15); }
        ...
        .profile-avatar.admin { background: linear-gradient(135deg, #e74c3c, #c0392b); }
        
        .btn-primary { background: #e74c3c; border: none; }
        .btn-primary:hover { background: #c0392b; transform: translateY(-2px); box-shadow: 0 5px 20px rgba(231, 76, 60, 0.3); }
            ...
            <nav class="col-md-2 sidebar">
                ...
                <div class="user-info d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="user-role"><i class="bi bi-shield-check"></i> <?php echo ucfirst($user_data['role'] ?? 'admin'); ?></div>
                    </div>
                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="text-center mb-4">
                                    ...
                                    <span class="badge bg-primary"><?php echo ucfirst($user_data['role'] ?? 'admin'); ?></span>
                                </div>
                                ...
                                <form method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="photo-help">
                                            ...
                                            Enter a URL for your profile photo (e.g., from Gravatar or any image hosting service)
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" 
                                               value="<?php echo ucfirst($user_data['role'] ?? 'admin'); ?>" disabled>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 text-center">
                                        <div class="p-3 bg-light rounded">
                                            ...
                                            <small class="text-muted">Last Login (Now)</small>
                                        </div>
                                    </div>
                                    <div class="col-md-3 text-center">
                                        <div class="p-3 bg-light rounded">
                                            <h5><?php echo ucfirst($user_data['role'] ?? 'admin'); ?></h5>
